    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', async function () {
            ...
            if (performSpecificSearchViaUrl) {
                ...
                // handleSearchFormSubmit now returns true if it proceeds, false if validation fails
                ...
                // If searchAttemptedAndValid is true, fetchHotels was called by handleSearchFormSubmit
            } else {
