                ...
                >
                    ...
                    <div class="btn-position-md-middle">
                        <a
                            ...
                            href="#"
                            wire:click.prevent="searchHotels"
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <!-- Alert box START -->
                    <div
                        class="alert alert-danger alert-dismissible d-flex justify-content-between align-items-center rounded-3 fade show mb-4 mb-0 pe-2"
                        role="alert"
                    >
                        <div class="d-flex">
                        ...
                        <button
                            type="button"
                            class="btn btn-link pb-0 text-end"
                    ...
                    >
                        ...
                        <div class="offcanvas-body flex-column p-3 p-xl-0">
                            <form class="rounded-3 shadow">
                                ...
                                <!-- Amenities START -->
                                <div
                                    class="card card-body rounded-0 rounded-bottom p-4"
                                >
                                    <!-- Title -->
                    ...
                    <div class="vstack gap-4">
                        ...
                        <div class="card shadow p-2">
                            <div class="row g-0">
                                ...
                                <div class="col-md-5 position-relative">
                                    <!-- Overlay item -->
                                    <div
                                        class="position-absolute top-0 start-0 z-index-1 m-2"
                                    >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                <img
                                                    src="assets/images/category/hotel/4by3/04.jpg"
                                                    alt="Card image"
                                                />
                                            </div>
                                            ...
                                            <div>
                                                <img
                                                    src="assets/images/category/hotel/4by3/02.jpg"
                                                    alt="Card image"
                                                />
                                            </div>
                                            ...
                                            <div>
                                                <img
                                                    src="assets/images/category/hotel/4by3/01.jpg"
                                                    alt="Card image"
                                                />
                                            </div>
                                        </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <ul class="list-inline mb-0">
                                                ...
                                                >
                                                    <i
                                                        class="fa-solid fa-star-half-alt text-warning"
                                                    ></i>
                                                </li>
                                            </ul>

                                            <ul
                                                class="list-inline mb-0 z-index-2"
                                            >
                                                <!-- Heart icon -->
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <i
                                                            class="fa-solid fa-fw fa-share-alt"
                                                        ></i>
                                                    </a>
                                                    <!-- dropdown button -->
                                                    <ul
                                                    ...
                                                    >
                                                        <li>
                                                            ...
                                                            >
                                                                <i
                                                                    class="fab fa-twitter-square me-2"
                                                                ></i>
                                                                Twitter
                                                            </a>
                                                        </li>
                                        ...
                                        <!-- List -->
                                        <ul
                                            class="list-group list-group-borderless small mb-0 mt-2"
                                        >
                                            <li
                                                class="list-group-item d-flex text-success p-0"
                                            >
                                                <i
                                                    class="bi bi-patch-check-fill me-2"
                                                ></i>
                        ...
                        <div class="card shadow p-2">
                            <div class="row g-0">
                                ...
                                <div class="col-md-7">
                                    <div
                                        class="card-body py-md-2 d-flex flex-column h-100"
                                    >
                                        <!-- Rating and buttons -->
                                        <div
                                            class="d-flex justify-content-between align-items-center"
                                        ...
                                        >
                                            <li
                                                class="list-group-item d-flex text-danger p-0"
                                            >
                                                <i
                                                    class="bi bi-patch-check-fill me-2"
                                                ></i>
                                ...
                                <div class="col-md-5 position-relative">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                <img
                                                    src="assets/images/category/hotel/4by3/06.jpg"
                                                    alt="Card image"
                                                />
                                            </div>
                                        </div>
