...
@section('title', 'Reservation Confirmation - ' . config('app.name'))
...
@section('content')
    <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #333;">
        We are pleased to confirm that your reservation has been successfully processed.
    </p>
    ...
    @include('mail.components.info-table', [
        ...
        'items' => [
            ...
            'Status' => ucfirst($reservation->status ?? 'confirmed'),
        ],
    ])
